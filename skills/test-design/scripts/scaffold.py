...
Generated by the test-design scaffold · the 4-tier task structure and all rules live in the
test-design skill.
...
def main():
    p = argparse.ArgumentParser(description="Scaffold a test documentation set (test-design skill)")
